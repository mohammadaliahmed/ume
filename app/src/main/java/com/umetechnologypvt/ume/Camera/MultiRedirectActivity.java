 ...
 */
public class MultiRedirectActivity extends AppCompatActivity {
...
//    ImageView send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_redirect);
        ...
        riversRef.putFile(file)
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        mDatabase.child("Posts").child("Posts").child(model.getId()).child("videoUrl").setValue("" + downloadUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                CompressImageToThumbnail compressImage = new CompressImageToThumbnail(MultiRedirectActivity.this);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        // ...
                        Toast.makeText(MultiRedirectActivity.this, exception.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
