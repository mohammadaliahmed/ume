...
public class UserOnlyPostsFragment extends Fragment {
    Context context;
...
//
    private void getPostIdsFromDB() {
        mDatabase.child("PostsBy").child(Constants.USER_ID).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
